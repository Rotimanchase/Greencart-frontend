                ...
                <div className="flex gap-3">
                    <div className="flex flex-col gap-3">
                        {product.images.map((image) => (
                            <div key={image} onClick={() => setThumbnail(image)} className="border max-w-24 border-gray-500/30 rounded overflow-hidden cursor-pointer" >
                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    <div className="flex items-center gap-0.5 mt-1">
                        {Array(5).fill('').map((_, i) => (
                            <img key={i} src={i<4 ? assets.star_icon : assets.star_dull_icon} alt="" className='w-3.5 md:2-4'/>
                        ))}
